...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static final double BORDER = 0.0;
    ...
    // keyboard state
    public final LinkedList<Character> keysTyped = new LinkedList<Character>();
    public final TreeSet<Integer> keysDown = new TreeSet<Integer>();

    // event-based listeners
    public final ArrayList<DrawListener> listeners = new ArrayList<DrawListener>();
    ...
    ***************************************************************************/
    ...
    public static void validate(double x, String name) {
    ...
    public static void validateNonnegative(double x, String name) {
